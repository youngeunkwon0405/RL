...
class Policy(ColocatablePolicyInterface, GenerationInterface):
    def __init__(
        ...
        self.sharding_annotations = NamedSharding(
            ...
            names=["pipeline_parallel", "data_parallel", "expert_parallel", "tensor_parallel"],
        )
    ...
    def get_logprobs(
        ...
        futures = self.worker_group.run_all_workers_sharded_data(
            ...
            replicate_on_axes=["tensor_parallel", "expert_parallel", "pipeline_parallel"],
            output_is_replicated=["tensor_parallel", "expert_parallel", "pipeline_parallel"],
        )
