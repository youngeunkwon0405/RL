...
# An environment for multiple choice (mc) questions
...
class MCEnvironmentMetadata(TypedDict):
    ground_truth: str


@ray.remote
class MCEnvironment(EnvironmentInterface):
    DEFAULT_PY_EXECUTABLE = PY_EXECUTABLES.SYSTEM

    def __init__(self, cfg: MCEnvConfig):
    ...
    def step(
        ...
        metadata: List[MCEnvironmentMetadata],
    ) -> EnvironmentReturn:
